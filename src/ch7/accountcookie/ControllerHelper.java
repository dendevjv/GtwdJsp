...
public class ControllerHelper extends HelperBaseCh5 {
	private static final String JSP_BASE = "/WEB-INF/ch7/accountcookie/";
	...
	public String getMethod() {
	    ...
	    Cookie accountCookie = CookieUtil.findCookie(request, "account");
	    if (accountCookie != null) {
	        Object dataPersistent = HibernateHelper.getFirstmatch(
                    data.getClass(), "accountNumber", accountCookie.getValue());
    ...
    public String processMethod() {
        ...
        response.addCookie(new Cookie("account", data.getAccountNumber()));
